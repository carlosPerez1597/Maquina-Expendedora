...
<Library LVVersion="20008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		...
		<Item Name="Process buy UI Msg.lvclass" Type="LVClass" URL="../../UI Actor Messages/Process buy UI Msg/Process buy UI Msg.lvclass"/>
		<Item Name="Send product selection Msg.lvclass" Type="LVClass" URL="../../UI Actor Messages/Send product selection Msg/Send product selection Msg.lvclass"/>
	</Item>
